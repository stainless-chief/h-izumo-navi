...
import "./satisfactionmap-page.scss";
...
function SatisfactionmapPage() {
  ...
  useEffect(() => {
    const fetchData = async() => {
      ...
      if (result.isSucceed) {
        reloadHeatZone(["Izumo_Navi_Like"]);
      } else {
  ...
  if (heatZones == null) {
    ...
    return (
      <div className="satisfaction-map-container">
